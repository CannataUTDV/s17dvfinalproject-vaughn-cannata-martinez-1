---
title: "<center>Austin Restaurant Inspections</center>"
...
<br>
To determine whether Chinatown's very low average score is unique, or whether it's a relatively common problem for restaurants with one or more low individual scores, we can look to the Tableau visualization.  Below is a boxplot showing all restaurants in the City of Austin with at least one score below 57.  Chinatown's closely-grouped low scores still stand out, but we can see that a few other restaurants have similarly low average scores.
<center>![Boxplot for Scores Below 57](../03 Visualizations/TBoxplot.png)</center>
<br>
...
<br>
This visualization seems to indicate that there are zipcodes in Austin where naturalized citizens and non-native residents account for more than a quarter of the population.  These zip codes are highlighted here:
<center>![Map of Non-native Residents](../03 Visualizations/PctNonnative.png)</center>
<br>
These percentages seem remarkably high, which made us wonder about the quality of our data.  We drew our citizenship information from the 2015 ACS dataset published by the United States Census and made available by data.world: https://data.world/uscensusbureau/acs-2015-5-e-foreignbirth/file/USA_ZCTA.csv .  We checked this information against other zipcode-based population information, this time from the 2010 census, available here: https://data.world/nrippner/fips-to-zip-code-crosswalk .  A quick check of the differences between these two population counts shows that they seem to be in accordance with one another, when taking the rapid growth of Austin's suburbs into account.  Below is a map showing the difference between the 2010 Census data and the 2015 ACS data.  (Red indicates growth over that five-year span.)
<center>![Map of Population Difference](../03 Visualizations/PopDiff.png)</center>
...
This boxplot shows the restaurants with at least one score below a user-defined threshold, as filitered by zip code.  Users may select any or all zipcodes within the greater Austin area.  This visualization helps show the general trend towards higher scores, even with restaurants with one or more low scores.
<center>![Tableau: Scores Below Cutoff Boxplot](../03 Visualizations/TBoxplot.png)</center>

###**Histogram- Raw Scores**
...
###**Scatterplot- CapMetro Stops and Restaurant Density as they Relate to Population**
