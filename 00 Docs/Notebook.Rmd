---
title: "DV Project 6"
author: "<center><b>Marcus Martinez, Chris Cannata, and Kate Vaughn</b></center>"
...
Click here to be taken to our published Shiny app: https://kvaughn.shinyapps.io/project_6/
...
<center>![Shiny: Safety Index Data](../03 Visualizations/ShinySafetyIndex1.png)</center> 
<center>![Shiny: Safety Index Crosstab](../03 Visualizations/ShinySafetyIndex2.png)</center>
...
<center>![Shiny: Lowest Inspection Scores Data](../03 Visualizations/ShinyLowestInspectionScores1.png)</center> 
<center>![Shiny: Lowest Inspection Scores Crosstab](../03 Visualizations/ShinyLowestInspectionScores2.png)</center>
...
<center>![Shiny: People per Restaurant Data](../03 Visualizations/ShinyPeopleperRestaurant1.png)</center> 
<center>![Shiny: People per Restaurant Crosstab](../03 Visualizations/ShinyPeopleperRestaurant2.png)</center>

##**Barchart Visualizations using Shiny in R**
These visualizations are also accessible at https://kvaughn.shinyapps.io/project_6/

###*Scores by Zip Code*
Barcharts can be a good way to quickly identify trends visually.  In this visualization, the user can create a set of zip codes of interest, then see each zipcode's average score per year over the three or four years contained in the dataset.  A table calculation of overall average score per zipcode is also represented for ease of comparison.

<center>![Shiny: Scores by Zip Code Select](../03 Visualizations/Bar1A.png)</center> 
<center>![Shiny: Scores by Zip Code Data](../03 Visualizations/Bar1B.png)</center> 
<center>![Shiny: Scores by Zip Code Bar Chart](../03 Visualizations/Bar1C.png)</center>
...
<center>![Shiny: Restaurant Density and Transit Stops Data](../03 Visualizations/Bar2A.png)</center> 
<center>![Shiny: Restaurant Density and Transit Stops Bar Chart](../03 Visualizations/Bar2B.png)</center>
...
<center>![Shiny: Restaurant Density and Nonnative Residents Data](../03 Visualizations/Bar3A.png)</center> 
<center>![Shiny: Restaurant Density and Nonnative Residents Bar Chart](../03 Visualizations/Bar3B.png)</center>
